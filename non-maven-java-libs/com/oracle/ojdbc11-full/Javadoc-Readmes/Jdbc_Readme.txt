Oracle JDBC Driver release 21.9.0.0 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 21.9.0.0 release:

  - JDBC Thin Driver 21.9.0.0
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 21.9.0.0
    Client-side JDBC driver for use on a machine where OCI 21.9.0.0
    is installed.

  - JDBC Thin Server-side Driver 21.9.0.0
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 21.9.0.0
...
For the Windows platform:
  ...
  [ORACLE_HOME]\bin directory contains ocijdbc21.dll and
  heteroxa21.dll, which are the libraries used by the JDBC OCI
  driver.

For non-Windows platforms:

  [ORACLE_HOME]/lib directory contains libocijdbc21.so,
  libocijdbc21_g.so, libheteroxa11.so and libheteroxa21_g.so, which
